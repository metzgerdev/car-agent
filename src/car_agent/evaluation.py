    ...
    for scenario in cases:
        ...
        for turn, response in zip(scenario.turns, responses):
            ...
            for call in response.trace:
                if call.name != "search_inventory" or scenario.budget_max is None:
                    continue
...
def phase3_scenarios() -> list[Phase3Scenario]:
    ...
    return [
        Phase3Scenario(
            ...
            forbidden_tools=["search_inventory"],
        ...
        Phase3Scenario(
            ...
            required_tools=["search_inventory", "get_vehicle", "retrieve_vehicle_facts"],
        ...
        Phase3Scenario(
            ...
            expected_stage="recommending",
            required_tools=["compare_vehicles"],
        ...
        Phase3Scenario(
            ...
            expected_stage="recommending",
            required_tools=["retrieve_vehicle_facts"],
        ...
        Phase3Scenario(
            ...
            expected_stage="qualifying",
            forbidden_tools=["search_inventory", "get_vehicle"],
        ...
        Phase3Scenario(
            ...
            expected_stage="recommending",
            forbidden_final_tools=["retrieve_vehicle_facts"],
        ...
        Phase3Scenario(
            ...
            expected_stage="qualifying",
            forbidden_tools=["schedule_test_drive"],
        ...
        Phase3Scenario(
            ...
            required_tools=["schedule_test_drive"],
