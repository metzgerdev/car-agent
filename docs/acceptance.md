...
| 2026-09-08 | Phase 2 inventory description cleanup | Removed the internal `Synthetic auction-style listing for an` label from generated descriptions and added a regression assertion; 83 Python tests pass | pending | none |
