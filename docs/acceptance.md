...
| 2026-09-07 | Phase 4 inventory tagline | Added the corrected tagline `Specializing in classic/modern-classic enthusiast sports cars` beneath the Grand Prix Motors Inventory label; 77 Python tests, 4 frontend tests, and frontend build pass | `pending` | none |
