...
| 2026-09-07 | Phase 4 minimal composer | Removed the `Text chat` and `Grounded by inventory and source records` helper text below the composer; 77 Python tests, 4 frontend tests, and frontend build pass | `pending` | none |
