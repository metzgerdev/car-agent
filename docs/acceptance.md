...
| 2026-09-06 | Phase 4 app simplification | Removed the user-facing agent evaluation mode, its API metadata, browser cockpit, and latency bookkeeping; normal JSON/SSE chat, Tool Trace, voice, and the Phase 3 scenario evaluator remain; 80 Python tests, 4 frontend tests, and frontend build pass | `bc1799b` | none |
