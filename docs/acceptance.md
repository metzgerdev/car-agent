...
| 2026-09-08 | Phase 4 gallery image loading state | Gallery photos show a centered spinner while loading, clear it on success or failure, and preserve the existing fallback visual and clean source-photo presentation; 83 Python tests, 8 frontend tests, and frontend build pass | pending | none |
