...
| 2026-09-07 | Phase 4 fixed chat composer and auto-scroll | Constrained the conversation to a fixed-height flex surface, kept the composer sticky at the bottom, and explicitly enabled assistant-ui bottom-following for new messages; 81 Python tests, 6 frontend tests, and frontend build pass | `f5c0711` | none |
