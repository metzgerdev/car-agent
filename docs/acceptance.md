...
| 2026-09-08 | Phase 3 REST-style tool semantics | Inventory collection, vehicle resource, vehicle subresources, comparison resource, and test-drive creation tools use consistent resource-oriented names and trace contracts; 93 Python tests pass | `pending implementation commit` | none |
