...
| 2026-09-08 | Phase 4 varied starter prompts | Added six additional enabled starter prompts covering facts, magazine reviews, service history, comparison, exact availability, and vehicle details; frontend tests and production build pass | `pending implementation commit` | none |
