...
The project intentionally uses a checked-in mock inventory fixture to
demonstrate multi-source enrichment and agent grounding. Freshness is not an
acceptance criterion; typed validation, provenance, source separation, and
deterministic recorded fixtures are.
